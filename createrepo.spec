...
# 6.5 fast
Patch11: BZ-877301-C-option-does-nothing-on-empty-repo.patch
Patch12: BZ-892657-fix-options-documentation.patch

# 6.6
Patch21: BZ-952602-modifyrepo-options.patch
...
* Thu Apr 17 2014 Valentina Mukhamedzhanova <vmukhame@redhat.com> - 0.9.9-21
- Improve package description.
- Resolves: rhbz#1088886

* Tue Apr 8 2014 Valentina Mukhamedzhanova <vmukhame@redhat.com> - 0.9.9-20
- Catch IOErrors when loading pkglist.
- Resolves: rhbz#1083185
- Fix OSError when running createrepo on CIFS shares.
- Resolves: rhbz#1035588

* Wed Apr 2 2014 Valentina Mukhamedzhanova <vmukhame@redhat.com> - 0.9.9-19
- Options --checksum, --unique-md-filenames, --simple-md-filenames for modifyrepo.
- Resolves: rhbz#952602

* Tue May 14 2013 James Antill <james.antill@redhat.com> - 0.9.9-18
- Option -C does nothing on empty repo.
- Resolves: rhbz#877301
- Fix the options documentation.
- Resolves: rhbz#892657
